...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DvNA0yya.js");
...
var manifest = {
	"65dde5507b874be2da0e46951b733f69cc6516b04a97a079e802bdbc53b7464f": {
		functionName: "analyzeImage_createServerFn_handler",
		importer: () => import("./assets/brain-3-vision.functions-BGLKNH7S.js")
	},
	"bcb6c8a0db223426023920cca66c8a30462120968482c6e4c7fb57f53fa7d8df": {
		functionName: "generateRecipe_createServerFn_handler",
		importer: () => import("./assets/orchestrator.functions-D5RxeM5u.js")
	},
	"bf749b4f96525eba3e4c251337487a416030439717530838e253c6ebfe4ebeb8": {
		functionName: "chatWithCulinaryAssistant_createServerFn_handler",
		importer: () => import("./assets/brain-8-chat.functions-B5dlmQUW.js")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-BC6K2FhS.js"),
