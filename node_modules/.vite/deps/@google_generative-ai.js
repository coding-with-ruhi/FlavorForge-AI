	...
	*/
	async sendMessage(request, requestOptions = {}) {
		...
		this._sendPromise = this._sendPromise.then(() => generateContent(this._apiKey, this.model, generateContentRequest, chatSessionRequestOptions)).then((result) => {
			var _a, _b;
			if (result.response.candidates && result.response.candidates.length > 0 && ((_a = result.response.candidates[0]) === null || _a === void 0 ? void 0 : _a.content) !== void 0) {
	...
	*/
	async sendMessageStream(request, requestOptions = {}) {
		...
		this._sendPromise = this._sendPromise.then(() => streamPromise).catch((_ignored) => {
			...
			var _a;
			if (response.candidates && response.candidates.length > 0 && ((_a = response.candidates[0]) === null || _a === void 0 ? void 0 : _a.content) !== void 0) {
				this._history.push(newContent);
