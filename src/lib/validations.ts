...
export const recipeModeSchema = z.enum(recipeModes)
...
export const recipeResultSchema = z.object({
  ...
  ingredients: z.array(z.object({
    name: z.string(),
    category: z.enum(['protein', 'vegetable', 'aromatic', 'flavor_builder', 'grain', 'dairy', 'spice', 'other']),
    amount: z.string(),
...
export const flavorAnalysisSchema = z.object({
